<!-- Enunciado original do desafio, preservado a partir do README.md do repositório base.
     Fonte: https://github.com/devfullcycle/mba-ia-desafio-design-docs-com-ia -->
